...
|`    print("Hello,", fname, mname, lname)           `|  `Hello, Amy Jhon Whatson` |
|`                                                   `|                            |
|`name("Amy")                                        `|                            |
...
|`    print("Hello,", fname, mname, lname)`               |  `Hello, Jade Peter Wesker`|
|`                                                   `    |                            |
...
| :----------------------------------------|:------------------------------------------------------------------|
|`def name(fname, mname, lname):`          |                                                                   |
|`    print("Hello,", fname, mname, lname)`|`name("Peter", "Quill")\`                                          |
...
| :----------------------------------------|:---------------------------|
|`def name(fname, mname, lname):`          |                            |
|`    print("Hello,", fname, mname, lname)`|  `Hello, Peter Ego Quill`  |
|`                                        `|                            |
...
| :----------------------------------------------------------------|:-----------------------------|
|`def name(**name):`                                               |                              |
|`    print("Hello,", name["fname"], name["mname"], name["lname"])`|`Hello, James Buchanan Barnes`|
|`                                        `                        |                              |
...
| :--------------------------------------------------------|:-----------------------------|
|`def name(fname, mname, lname):`                          |                              |
|`    return "Hello, " + fname + " " + mname + " " + lname`|`Hello, James Buchanan Barnes`|
|`                                        `                |                              |
...
<div align="center">
  ...
  **TO BE CONTINUED IN NEXT CHIT SHEET PYTHON FILE** 
